    ...
    <Grid container direction='column' className={classes.mainContainer}>
        ...
        <Grid item container direction='row' justifyContent='space-around'>
            ...
            <Grid md>            
                <Grid item container direction='row'>
                    <Grid item container className={classes.itemContainer}>
                        <Grid item md>
                            <Lottie options={scaleOptions} style={{maxHeight: 200, maxWidth:200}}/>
                        </Grid>
                        <Grid item container direction='column' classes={classes.itemContainer} md>
                            <Grid item>
                            ...
                            <Grid item >
                                <Typography variant='body1' paragraph>
                                    Wheter you are a large brand just getting started or taking off right now, our application architecture ensures pain-free growth and reliability.
                                </Typography>
                            </Grid>
                        </Grid>
                    </Grid>
        ...
        <Grid item container direction='row'>
            <Grid item container direction='column' alignItems='center'>
                <Grid item >
                    <img src={roots} alt='' height='450em' width='450em'/>
                </Grid>
